...
import requests 
import csv
csvfile = 'C:/Users/vineeth.vijay.das/Desktop/Python/Web_Scrapping/example.csv'# location of the CSV file
import bs4

y = 2011 # to initialize year 
m = 1
d = 1
numbr = 40544 # constant number for the year 2010 - 40179, 2011 - 40544, 2012(leap year) -40909, 2013 - 41275, 2014 - 41640, 2015 - 42005, 2016(leap) - 42370, 2017 - 42736, 2018 - 43101, 2019 -43466 
